...
REQUIRED_FILES = [
    ...
    Path("src/wafer_map_analysis.py"),
    Path("src/wafer_torch.py"),
    Path("src/wafer_ai_outputs.py"),
    Path("src/equipment_features.py"),
    Path("src/equipment_anomaly.py"),
    ...
    Path("src/integrated_dashboard.py"),
    ...
    Path("scripts/analyze_wafer_maps.py"),
    Path("scripts/analyze_equipment_anomalies.py"),
    Path("scripts/generate_integrated_dashboard.py"),
    ...
    Path("tests/test_wafer_map_analysis.py"),
    Path("tests/test_wafer_torch.py"),
    Path("tests/test_equipment_anomaly.py"),
    Path("tests/test_integrated_dashboard.py"),
]
